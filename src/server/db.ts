...
const DEFAULT_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    image: '/products/new_plant_05.jpg',
  ...
  },
  {
    ...
    image: '/products/new_plant_13.jpg',
...
const DEFAULT_SETTINGS: SiteSettings = {
  ...
  enableRazorpay: true,
  razorpayKeyId: process.env.RAZORPAY_KEY_ID || 'rzp_test_TPhhoBxVXsxTpD',
  razorpayKeySecret: process.env.RAZORPAY_KEY_SECRET || 'deYVUZfzzRp1mXaqioKd3GZw',
  enableCod: true,
  enablePhonePe: true,
